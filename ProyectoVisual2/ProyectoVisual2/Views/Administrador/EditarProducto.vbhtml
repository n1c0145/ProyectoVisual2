...
End Code
    ...
    <body style="background-color:black">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <center><picture style="font: oblique bold 120% cursive"><h1 class="display-4"></picture>Editar Producto</h1></center>
            </div>
        </div>

        @Using (Html.BeginForm("ActualizarProducto", "Administrador", FormMethod.Post))
            @Html.AntiForgeryToken()

            @<div class="form-horizontal" readonly class="form-control-plaintext" style="color:navajowhite">
                <h4><picture style="font: oblique bold 120% cursive">Producto Inventario</h4>
                <hr />
